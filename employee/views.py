...
from .models import employeedetails, employee_attendance, employee_personaldetails, employee_educationaldetails, employee_experiencedetails,applied_leaves, weeklyactivity
    ...
    if 'user' in request.session:
        ...
        if request.method == 'POST':
            ...
            if 'qs1' not in request.FILES:
                ...
                return render(request,'dashboard.html',{'image':request.session['image']})
    else:
